    ...
    <div style={{ minHeight: '100vh', background: '#f3f4f6' }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '24px', borderBottom: '1px solid #e5e7eb' }}>
          ...
          <p style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>Logistics OS</p>
        </div>
      ...
      {/* Main Content */}
      <div style={{ marginLeft: sidebarOpen ? '260px' : '0', transition: 'margin-left 0.3s' }}>
        <header style={{
          background: 'white',
          padding: '16px 24px',
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div>
              <span style={{ color: '#6b7280' }}>Admin Portal</span>
            </div>
          </div>
        </header>
        <main>{children}</main>

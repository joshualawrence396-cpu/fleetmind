...
export default function WarehouseDetail({ params }: PageProps) {
      ...
      try {
        ...
        const found =
          Array.isArray(warehouses)
            ? warehouses.find((w: Warehouse) => w.id === warehouseId)
            : null
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ fontWeight: '500' }}>{warehouse.code}</p>
            </div>

            <div>
              <p style={{ color: '#666' }}>Name</p>
              <p style={{ fontWeight: '500' }}>{warehouse.name}</p>
            </div>

            <div>
              <p style={{ color: '#666' }}>Location</p>
              <p style={{ fontWeight: '500' }}>
                Lat: {warehouse.latitude ?? 'N/A'}, Lng:{' '}

  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      sender: 'Josh Driver',
      role: 'driver',
      text: 'On my way to delivery address, ETA 20 mins',
      time: '09:10',
      mine: false,
    },
    {
      ...
      sender: 'Admin',
      role: 'admin',
      text: 'Great, customer has been notified',
      time: '09:11',
      mine: true,
    },
    {
      ...
      sender: 'Jake Driver',
      role: 'driver',
      text: 'Completed Order ORD-002, returning to depot',
      time: '09:25',
      mine: false,
    },
  ])
          ...
          {contacts.map((c) => (
            <div
              ...
              style={{
                ...
                marginBottom: 4,
                background:
                  activeChat === c.id ? '#f1f5f9' : 'transparent',
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: m.mine
                        ? '12px 12px 4px 12px'
                        : '12px 12px 12px 4px',
                      background: m.mine ? '#3b82f6' : '#f1f5f9',
